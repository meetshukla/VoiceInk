...
class UpdaterViewModel: ObservableObject {
    ...
    init() {
        #if LOCAL_BUILD
        // Local builds are updated by the repository-owned updater. Starting
        // Sparkle here would point the app at the production release feed and
        // could replace the local build with a production bundle.
